...
void bubbleDown(int currentIndex) {
        ...
        if (leftChild <= heapIndex) {
                if (myHeap[leftChild].frequency < myHeap[smallest].frequency) {
                        smallest = leftChild;
                } else if (myHeap[leftChild].frequency == myHeap[smallest].frequency) {
                        if (compareString(myHeap[leftChild].word, myHeap[smallest].word) > 0) {
                                smallest = leftChild;
                        }
                }
        }
        ...
        if (rightChild <= heapIndex) {
                if (myHeap[rightChild].frequency < myHeap[smallest].frequency) {
                        smallest = rightChild;
                } else if (myHeap[rightChild].frequency == myHeap[smallest].frequency) {
                        if (compareString(myHeap[rightChild].word, myHeap[smallest].word) > 0) {
                                smallest = rightChild;
                        }
                }
        }
